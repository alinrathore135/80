function submit()
{
    ...
    for (var j = 1; j <= 4; j++)
    {
        var name_of_the_student = document.getElementById("name_of_the_student_"+).nodeValue;
...
function sorting()
{
    ...
    for (var k = 0; k < length_of_name_of_students_array; k++)
    {
        display_student_array.sorting.push("<h4>NAME - " + name_of_the_student_array[k] + "</h4>");
        console.log(remove_commas);
